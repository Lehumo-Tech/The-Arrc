...
export const LEADERS = [
  ...
  { title: "Calvin Nkosi", subtitle: "Deputy President", description: "Calvin Nkosi serves as the Deputy President of the African Royal Rainbow Congress (ARRC). As the second-in-command of the movement, Deputy President Nkosi deputises for the President and plays a central role in guiding the organisation's strategic direction, governance, and national mobilisation efforts. A principled leader and committed advocate for the people, he ensures that the ARRC remains accountable, transparent, and rooted in the communities it serves.", imageUrl: `/leaders/deputy-president-nkosi.jpeg`, featured: false, sortOrder: 2 },
  { title: "Princess Lobisa Chokwe", subtitle: "Deputy President / Business Affairs", description: "Princess Lobisa Chokwe serves as the Deputy President / Business Affairs of the African Royal Rainbow Congress (ARRC). A champion for economic empowerment and township entrepreneurship, Deputy President Chokwe leads the party's agenda to reclaim local economies for South Africans — ensuring that spaza shops, salons, taverns, and small businesses in our communities belong to and benefit the people who live there. Her guiding belief: \"Together we build a better tomorrow.\"", imageUrl: `/leaders/deputy-president.jpeg`, featured: false, sortOrder: 3 },
  { title: "Tidimalo Tsatsi Esq.", subtitle: "Vice Chairperson", description: "Tidimalo Tsatsi Esq. serves as the Vice Chairperson of the African Royal Rainbow Congress (ARRC). A legal professional and passionate advocate for justice, Tsatsi deputises for the Chairperson and plays a central role in guiding the organisation's governance and strategic direction.", imageUrl: `/leaders/vice-president.png`, featured: false, sortOrder: 4 },
  { title: "Aaron Matsimela", subtitle: "Chairperson", description: "Aaron Matsimela is the Chairperson of the African Royal Rainbow Congress (ARRC). A visionary leader and passionate advocate for social justice, economic empowerment, and the restoration of African dignity.", imageUrl: `/leaders/chairperson.jpeg`, featured: false, sortOrder: 5 },
  { title: "Johanna Mapeko", subtitle: "Secretary General", description: "Johanna Mapeko serves as the Secretary General of the African Royal Rainbow Congress (ARRC), the chief administrative officer of the organisation.", imageUrl: `/leaders/secretary-general.png`, featured: false, sortOrder: 6 },
